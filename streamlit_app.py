...
def main():
    ...
    col3.metric("Capacité totale (GWh/an)", str(df_pts["Capacite de production (GWh/an)"]\
                                                            .sum().round(1)))
    ...
    with col1:
        ...
        df_pts_annee_plot = df_pts_annee[df_pts_annee['Annee mise en service'] != 2023]\
    ...
    with col2:
        ...
        # Prepare Data 
        df_pts[['latitude', 'longitude']] = df_pts[df_pts['Annee mise en service'] == 2022]['Coordonnees']\
    ...
    with col1:
        ...
        with col1_bis:
            # streamlit component
            date_1 = st.date_input("Sélectionner une date de début:",
        ...
        with col2_bis:
            # streamlit component
            date_2 = st.date_input("Sélectionner une date de fin:",
